...
<!-- Mirrored from code-theme.com/html/findhouses/register.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 27 Jul 2021 22:30:17 GMT -->
...
{{--    <link rel="stylesheet" href="{{asset('assets/frontend/revolution/css/settings.css')}}">--}}
{{--    <link rel="stylesheet" href="{{asset('assets/frontend/revolution/css/layers.css')}}">--}}
{{--    <link rel="stylesheet" href="{{asset('assets/frontend/revolution/css/navigation.css')}}">--}}
<!-- ARCHIVES CSS -->
    ...
    <div class="login-and-register-form modal">
        ...
        <div class="main-register-holder">
            <div class="main-register fl-wrap">
                ...
                <h3>Welcome to <span>Berina <strong>Search</strong></span></h3>
