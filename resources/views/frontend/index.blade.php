                                ...
                                <div class="listing-item compact">
                                    <a href="#" class="listing-img-container">
                                        <div class="listing-badges">
                                            ...
                                            <span>For {{ optional($listing->type)->name ?? '' }}</span>
                                        </div>
                                        <div class="listing-img-content">
                                            <span
                                                class="listing-compact-title">{{ $listing->title }} <i>{{ $listing->city }}</i></span>
                                            <ul class="listing-hidden-content blue">
                                                <li>Area <span>{{ $listing->area }}</span></li>
                                                <li>Rooms <span>{{ $listing->no_of_room }}</span></li>
                                                <li>Beds <span>{{ $listing->no_of_bed }}</span></li>
                                                <li>Baths <span>{{ $listing->no_of_bath }}</span></li>
                                            </ul>
                                        </div>
                ...
                <article class="col-lg-4 col-md-6 col-xs-12 serv" data-aos="fade-up">
                    <div class="serv-flex">
                        <div class="art-1 img-13">
                            <img src="assets/frontend/images/icons/icon-4.svg" alt="">
                ...
                <article class="col-lg-4 col-md-6 col-xs-12 serv" data-aos="fade-up">
                    <div class="serv-flex">
                        <div class="art-1 img-14">
                            <img src="assets/frontend/images/icons/icon-5.svg" alt="">
                ...
                <article class="col-lg-4 col-md-6 col-xs-12 serv mb-0 pt" data-aos="fade-up">
                    <div class="serv-flex arrow">
                        <div class="art-1 img-15">
                            <img src="assets/frontend/images/icons/icon-6.svg" alt="">
                    ...
                    <div class="project-single" data-aos="zoom-in">
                        <div class="listing-item compact">
                            <a href="single-property-1.html" class="listing-img-container">
                                ...
                                <img src="assets/frontend/images/feature-properties/fp-1.jpg" alt="">
                            </a>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="project-single" data-aos="zoom-in">
                        <div class="listing-item compact">
                            <a href="single-property-1.html" class="listing-img-container">
                                ...
                                <img src="assets/frontend/images/feature-properties/fp-2.jpg" alt="">
                            </a>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="project-single" data-aos="zoom-in">
                        <div class="listing-item compact">
                            <a href="single-property-1.html" class="listing-img-container">
                                ...
                                <img src="assets/frontend/images/feature-properties/fp-3.jpg" alt="">
                            </a>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="project-single no-mb" data-aos="zoom-in">
                        <div class="listing-item compact">
                            <a href="single-property-1.html" class="listing-img-container">
                                ...
                                <img src="assets/frontend/images/feature-properties/fp-4.jpg" alt="">
                            </a>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="project-single no-mb" data-aos="zoom-in">
                        <div class="listing-item compact">
                            <a href="single-property-1.html" class="listing-img-container">
                                ...
                                <img src="assets/frontend/images/feature-properties/fp-5.jpg" alt="">
                            </a>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="project-single no-mb last" data-aos="zoom-in">
                        <div class="listing-item compact">
                            <a href="single-property-1.html" class="listing-img-container">
                                ...
                                <img src="assets/frontend/images/feature-properties/fp-6.jpg" alt="">
                            </a>
                        </div>
                    </div>
                </div>
            ...
            <div class="row info-head">
                <div class="col-lg-4 col-md-6">
                    <div class="info-text" data-aos="fade-right">
                        ...
                        <p>We Help you find the best places and offer near you. Bring to the table win-win survival
                            strategies to ensure proactive domination going forward.</p>
                        ...
                        <div class="project-inner project-head">
                            <div class="homes">
                                ...
                                <a href="#" class="homes-img">
                                    ...
                                    <img src="{{asset('assets/frontend/mages/feature-properties/fp-10.jpg')}}"
                                         alt="home-1"
                                         class="img-responsive">
                                </a>
                            </div>
                ...
                <div class="row">
                        ...
                        <div class="news-item" data-aos="fade-up">
                            <a href="blog-details.html" class="news-img-link">
                                <div class="news-item-img">
                                    <img class="img-responsive" src="/assets/frontend/images/blog/b-1.jpg"
                                         alt="blog image">
                                </div>
                            </a>
                            <div class="news-item-text">
                                ...
                                <div class="news-item-bottom">
                                    ...
                                    <div class="admin">
                                        <p>By, Karl Smith</p>
                                        <img src="assets/frontend/images/testimonials/ts-6.jpg" alt="">
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="col-xl-4 col-md-6 col-xs-12">
                        <div class="news-item" data-aos="fade-up">
                            <a href="blog-details.html" class="news-img-link">
                                <div class="news-item-img">
                                    <img class="img-responsive" src="/assets/frontend/images/blog/b-2.jpg"
                                         alt="blog image">
                                </div>
                            </a>
                            <div class="news-item-text">
                                ...
                                <div class="news-item-bottom">
                                    ...
                                    <div class="admin">
                                        <p>By, Lis Jhonson</p>
                                        <img src="assets/frontend/images/testimonials/ts-5.jpg" alt="">
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="col-xl-4 col-md-6 col-xs-12">
                        <div class="news-item no-mb" data-aos="fade-up">
                            <a href="blog-details.html" class="news-img-link">
                                <div class="news-item-img">
                                    <img class="img-responsive" src="/assets/frontend/images/blog/b-3.jpg"
                                         alt="blog image">
                                </div>
                            </a>
                            <div class="news-item-text">
                                ...
                                <div class="news-item-bottom">
                                    ...
                                    <div class="admin">
                                        <p>By, Ted Willians</p>
                                        <img src="assets/frontend/images/testimonials/ts-4.jpg" alt="">
                                    </div>
                                </div>
                            </div>
                        </div>
    ...
    <div class="partners bg-white-3">
        <div class="container">
            ...
            <div class="owl-carousel style2">
                <div class="owl-item" data-aos="fade-up"><img src="/assets/frontend/images/partners//11.jpg" alt="">
                </div>
                <div class="owl-item" data-aos="fade-up"><img src="/assets/frontend/images/partners//12.jpg" alt="">
                </div>
                <div class="owl-item" data-aos="fade-up"><img src="/assets/frontend/images/partners//13.jpg" alt="">
                </div>
                <div class="owl-item" data-aos="fade-up"><img src="/assets/frontend/images/partners//14.jpg" alt="">
                </div>
                <div class="owl-item" data-aos="fade-up"><img src="/assets/frontend/images/partners//15.jpg" alt="">
                </div>
                <div class="owl-item" data-aos="fade-up"><img src="/assets/frontend/images/partners//16.jpg" alt="">
                </div>
                <div class="owl-item" data-aos="fade-up"><img src="/assets/frontend/images/partners//17.jpg" alt="">
                </div>
                <div class="owl-item" data-aos="fade-up"><img src="/assets/frontend/images/partners//11.jpg" alt="">
                </div>
                <div class="owl-item" data-aos="fade-up"><img src="/assets/frontend/images/partners//12.jpg" alt="">
