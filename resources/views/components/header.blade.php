    ...
    <div id="header">
        <div class="container container-header">
            ...
            <div class="left-side">
                <!-- Logo -->
                <div id="logo">
                    <a href="index.html"><img src="{{asset('assets/frontend/images/main-logo.png')}}" alt=""></a>
                </div>
                <!-- Mobile Navigation -->
...
{{--                            </ul>--}}
            ...
            <div class="right-side d-none d-none d-lg-none d-xl-flex">
                ...
                <div class="header-widget">
                    <a href="add-property.html" class="btn btn-yellow">Add Listing<i
...
@if(!auth('customer')->user())
            <div class="right-side d-none d-none d-lg-none d-xl-flex sign ml-0">
                ...
                <div class="header-widget sign-in">
                    <div class="show-reg-form modal-open"><a href="{{ route('customer.login') }}">Sign In</a></div>
                </div>
                <!-- Header Widget / End -->
            </div>
            @endif
